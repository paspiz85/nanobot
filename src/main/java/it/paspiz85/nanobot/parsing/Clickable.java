...
public enum Clickable {
    ...
    BUTTON_ATTACK_UNIT_1(72, 600, null), BUTTON_ATTACK_UNIT_2(145, 600, null), BUTTON_ATTACK_UNIT_3(217, 600, null), BUTTON_ATTACK_UNIT_4(
            ...
            new Color(0xECAC28)), BUTTON_RAX_ARCHER(331, 333, null, "Archer"), BUTTON_RAX_HOGRIDER(331, 333, null,
                                            "Hog Rider"), BUTTON_RAX_BALLOON(212, 451, null, "Balloon"), BUTTON_RAX_BARB(212, 324, null, "Barb"), BUTTON_RAX_MINION(
                                                    212, 324, null, "Minion"), BUTTON_RAX_CLOSE(729, 145, new Color(0xF8FCFF)), BUTTON_RAX_DRAGON(542, 451,
                                                            null, "Dragon"), BUTTON_RAX_FULL(156, 507, new Color(0xD04048)), BUTTON_RAX_GIANT(432, 333, null, "Giant"), BUTTON_RAX_GOBLIN(
                                                                    542, 333, null, "Goblin"), BUTTON_RAX_HEALER(432, 451, null, "Healer"), BUTTON_RAX_NEXT(767, 361,
                                                                            new Color(0xF8B046)), BUTTON_RAX_NO_UNIT(null, null, null, "No Unit"), BUTTON_RAX_PEKKA(642, 451, null,
                                                                                    "Pekka"), BUTTON_RAX_WB(642, 333, null, "Wall Breaker"), BUTTON_RAX_WIZARD(331, 451, null, "Wizard"), BUTTON_SHIELD_DISABLE(
                                                                                            512, 397, null), BUTTON_WAS_ATTACKED_HEADLINE(437, 158, new Color(0x585450)), BUTTON_WAS_ATTACKED_OKAY(432,
                                                                                                    507, new Color(0x5CAC10)), // 160,250
                                       // to
                                       // 700,420
