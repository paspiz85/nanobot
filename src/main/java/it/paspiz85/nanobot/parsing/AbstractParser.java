...
class AbstractParser {
    ...
    protected final Integer parseDigit(BufferedImage image, int xStart, int yStart, int type) {
        for (int i = 0; i < 10; i++) {
            boolean found = true;
    ...
    protected final int parseNumber(BufferedImage image, int type, int xStart, int yStart, int maxSearchWidth) {
        String no = "";
        int curr = xStart;
