...
Feature: single feature to test
  ...
  Scenario Outline: parse enemy info
    ...
    Examples:
      ...
      | classpath:/features/img/base_1435906215238.png | 135 | null | null         | null         | null            |
      ...
      | classpath:/features/img/base_1435906232991.png | 26 | null | null         | null         | null            |
      | classpath:/features/img/base_1435906237740.png | 17 | null | null         | null         | null            |
      | classpath:/features/img/base_1435906242449.png | 62 | null | null         | null         | null            |
