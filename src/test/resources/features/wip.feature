...
Feature: single feature to test
  ...
  Scenario Outline: parse enemy info
    ...
    Examples:
      ...
      | classpath:/features/img/base_1435775196561.png | 175494 | 144734 | 27         | null         | null            |
...
#      | classpath:/features/img/base_1435819920420.png | 2 | null | null         | null         | null            |
      ...
      | classpath:/features/img/base_1435906163980.png | 75103  | 58602  | 107         | null         | null            |
      | classpath:/features/img/base_1435906182442.png | 35443  | 306229 | 172         | null         | null            |
