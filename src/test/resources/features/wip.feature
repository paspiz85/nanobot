...
#      | classpath:/features/img/base_1435819920420.png | 2 | null | null         | null         | null            |
      ...
      | classpath:/features/img/base_1435906031260.png | 82 | null | null         | null         | null            |
      | classpath:/features/img/base_1435906058962.png | 82 | null | null         | null         | null            |
      ...
      | classpath:/features/img/base_1435906144152.png | 8 | null | null         | null         | null            |
      | classpath:/features/img/base_1435906163980.png | 751 | null | null         | null         | null            |
      | classpath:/features/img/base_1435906182442.png | 35 | null | null         | null         | null            |
      | classpath:/features/img/base_1435906189462.png | 18 | null | null         | null         | null            |
      | classpath:/features/img/base_1435906195366.png | 6 | null | null         | null         | null            |
      ...
      | classpath:/features/img/base_1435906220597.png | 187 | null | null         | null         | null            |
