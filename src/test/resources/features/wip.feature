...
#      | classpath:/features/img/base_1435819920420.png | 2 | null | null         | null         | null            |
      | classpath:/features/img/base_1435905910030.png | 36438  | 10009 | null         | null         | null            |
      | classpath:/features/img/base_1435905943068.png | 31037  | 216 | null         | null         | null            |
      | classpath:/features/img/base_1435905992009.png | 28447  | 1609 | null         | null         | null            |
      | classpath:/features/img/base_1435906013388.png | 94741  | 1610 | null         | null         | null            |
      | classpath:/features/img/base_1435906031260.png | 89284  | 9604 | null         | null         | null            |
      | classpath:/features/img/base_1435906058962.png | 48298  | 10699 | null         | null         | null            |
      | classpath:/features/img/base_1435906077198.png | 106328 | 662 | null         | null         | null            |
      | classpath:/features/img/base_1435906098470.png | 95253  | 9 | null         | null         | null            |
      | classpath:/features/img/base_1435906115317.png | 42075  | 2611 | null         | null         | null            |
      | classpath:/features/img/base_1435906126585.png | 115280 | 6990 | null         | null         | null            |
      ...
      | classpath:/features/img/base_1435906220597.png | 18471  | 291 | null         | null         | null            |
      | classpath:/features/img/base_1435906224691.png | 13319  | 91 | null         | null         | null            |
